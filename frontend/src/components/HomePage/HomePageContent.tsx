...
<div
  style={{
    background: 'linear-gradient(135deg, #785e93ff, #78658bff)',
...
{!isMobile && (
  ...
  >
    <h3 style={{ marginBottom: '1rem', fontSize: '1.5rem', color: '#574866ff' }}>
      Contact Us 
    </h3>
    <p style={{ marginBottom: '1.5rem', fontSize: '1rem', color: '#765b92ff' }}>
  ...
  style={{
    ...
    padding: '2rem 1rem',
    overflow: 'hidden',
    borderTop: '4px solid #584e62ff',       // Green top border
    borderBottom: '4px solid #584e62ff',    // Green bottom border
    marginTop: '3rem',
    textAlign: 'center',
  }}
>
